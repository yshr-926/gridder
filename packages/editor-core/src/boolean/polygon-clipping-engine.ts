...
const asLibGeom = (multiPolygon: ClosedMultiPolygon): LibGeom => multiPolygon as unknown as LibGeom;

const asClosedMultiPolygon = (multiPolygon: LibMultiPolygon): ClosedMultiPolygon =>
  multiPolygon as unknown as ClosedMultiPolygon;
...
export const createPolygonClippingEngine = (): PolygonBooleanEngine => new PolygonClippingEngine();
